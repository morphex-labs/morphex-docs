...
When you choose "Compound", your pending **Multiplier Points** and possible MPX rewards _will be staked_, which will _increase the number of rewards **you** receive_. When you select "Claim", any **pending rewards** will be _transferred_ to your **wallet**.

If you choose to compound or stake your **Escrowed MPX** tokens, you can unstake them for vesting at any time in the future.

## Escrowed MPX

Escrowed MPX (**esMPX**) can be used in two ways:
...
Escrowed MPX tokens are no longer distributed as per the Snapshot vote [here](https://snapshot.box/#/s:morphexbmx.eth/proposal/0xea1a6f37beb80e318f878e943beb3ef4da4f3d31443765fcf5e536db8259761e).

## Summary

Here is a **summary** of the rewards and mechanics:

- **MPX** tokens _earn_ **FTM** and **Multiplier Points** when staked
- **esMPX** tokens _earn_ **FTM** and **Multiplier Points** when staked
- **Multiplier Points** _boost_ **FTM** APRs when staked
- **MLP** tokens _earn_ **FTM**, and are _automatically staked_ when minted
