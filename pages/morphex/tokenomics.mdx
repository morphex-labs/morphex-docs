...
**30%** of fees generated from trading are converted to **FTM** on **Fantom** and **BNB** on **Binance Smart Chain** and distributed to staked **MPX tokens**. These are isolated in their respective chains.
