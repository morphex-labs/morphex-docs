...
*Per [BIP-12](https://snapshot.box/#/s:bmxonbase.eth/proposal/0x3ba379fc5b3d2f68743e69d3f75748a5341d8702533788d85f1bcddb28aafab7)*
### Classic:
- **65%** to **BLT/MLT** (streamed as wETH; auto-compounded into BLT/MLT if staked in wBLT/wMLT)  
- **15%** to liquidity incentives for wBLT-USDC and wMLT-USDC  
- **20%** to BMX single staking on Base and Mode

### Freestyle:
- **25%** to liquidity incentives for wBLT-USDC and wMLT-USDC  
- **35%** to **BLT/MLT**
