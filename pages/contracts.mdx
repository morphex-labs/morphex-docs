...
| **Contract** | **Address** |
| --- | --- |
| Vault | 0x9cC4E8e60a2c9a67Ac7D20f54607f98EfBA38AcF |
| bUSD | 0x25431F78c9B7be0F285301A6ACF334Cdb838C4D6 |
| Router | 0x0a2653a193595d91678830512DE2733727953169 |
| VaultPriceFeed | 0x8e28edBFb74F5ef7De12E5091CACDcE45EE0BEaC |
| SLT | 0x9E462d5603Bb983b74e941Ebd5CE9Ea76f3a9e1e |
| wSLT | 0x2dDCF85D3Cf27DEA338e0371D38409Ba80058630 |
| ShortsTracker | 0xE974A88385935CB8846482F3Ab01b6c0f70fa5f3 |
| GlpManager | 0xC608188e753b1e9558731724b7F7Cdde40c3b174 |
| VaultErrorController | 0x31e5Ff91e8471346dDEb41cb3E974950F1c256d4 |
| VaultUtils | 0x5174c02f20fe8b2da3E3A64FA7df5596cEF9BaD2 |
| OrderBook | 0x7e3F5E2D89f6C83988301989fa3fc3a4ea3612A6 |
| PositionRouter | 0x77F480fdB7100d096c2de1876C1f4960Fa488246 |
| PositionManager | 0x620253Be916A915fEE00Fab30840A04A2389C886 |
| ReferralStorage | 0xb677beDc61A0fFd4b9eA186Ca4015FB488741acB |
| ReferralReader | 0xd3C5dEd5F1207c80473D39230E5b0eD11B39F905 |
| BatchSender | 0x7724dfE8E461C59F5017d9A0eB510dD0e2d61eDC |
| Reader | 0x9C959a40f1d1f3bc5C7d02EC474d13eD25441A5e |
| RewardReader | 0x7c903C8a0eF673Ab03F9508Db7eFCf1cA723feaA |
| OrderBookReader | 0x145E8F5E576DA0c3c490fb54a0B363e7B1A9D587 |
| VaultReader | 0x071B4Bda55ac6fA67f42A8477311F603d494C3E8 |
| bnBMX | 0x1861FED3ca8dDcC31B37353e019e9741f6898Ae2 |
| sBMX (Tracker) | 0x7Fb62EfF63DEE8b6D6654858c75E925C08811B46 |
| sBMX (Distributor) | 0xDA6a454132d95c0542F8780b698E67479D42b462 |
| sbBMX (Tracker) | 0x6D6ec3bd7c94ab35e7a0a6FdA864EE35eB9fAE04 |
| sbBMX (BonusDistributor) | 0x92C97631450E804848781C0764907Ec4FC6fFd29 |
| sbfBMX (Tracker) | 0x3CB54f0eB62C371065D739A34a775CC16f46563e |
| sbfBMX (Distributor) | 0xB7209EbCBF71c0ffA1585B4468A11CFfdcDBB9a9 |
| fSLT (Tracker) | 0x3Acf67bD8C291F9C5bbBB14AC0eC86F60ABCE36E |
| fSLT (Distributor) | 0x86c48E2FFEaCee704B7B7840127BF2f325F075cf |
| fsSLT (Tracker) | 0xd5c313DE2d33bf36014e6c659F13acE112B80a8E |
| fsSLT (DistributorV2) | 0x4E762495b9521E7465DFD5aA8927668BCe7C137C |
| RewardRouterV4 | 0x0DF4DbeB0aeABbBB95cC600E7a268125A0Bb8064 |
| StakedSlt | 0x47cd080014fF0ebB097F49cF1303ad088eBFCFcb |
| GlpBalance | 0x6a24Df8dCF88127D93888f09e33eEaa7ce111aF0 |
| StakeManager | 0x8BC6D6d2cdD68E51a8046F2C570824027842eD8D |
| FastPriceEvents | 0xc0136b64E95697f8d22D77f702EF139a08536df2 |
| FastPriceFeed | 0x512F8D4E28EB53A6d036aEDA9C5a4D1De6DBD543 |
...
| sBMX (Distributor) | 0x338CF5cB178a25B6C84095d6Ac8Ec60Cd7B1D9c9 |
| sbBMX (Tracker) | 0x4a2b3ca2826FD4C9d3099F660DDC75ac2c944be9 |
| sbBMX (BonusDistributor) | 0x0DF4DbeB0aeABbBB95cC600E7a268125A0Bb8064 |
| sbfBMX (Tracker) | 0x548f93779fBC992010C07467cBaf329DD5F059B7 |
| sbfBMX (Distributor) | 0x26e6C47682FfC1824d7aC5512752FC671dA5e607 |
| fMLT (Tracker) | 0xCcBF79AA51919f1711E40293a32bbC71F8842FC3 |
| fMLT (Distributor) | 0x366152Fc0FC4680e0A05ce9739a4210228C72BA3 |
| fsMLT (Tracker) | 0x6c72ADbDc1029ee901dC97C5604487285D972A4f |
| fsMLT (DistributorV2) | 0x749DA3a34A6E1b098F3BFaEd23DAD2b7D7846b9B |
...
## Interacting with the contracts for BMX Classic:
...
- The StakedGmxTracker routes esMPX to staked tokens
- After this step, the RewardRouter deposits the StakedGmxTracker tokens into the BonusGmxTracker
- The BonusGmxTracker routes Multiplier Points to staked tokens
- Finally, the BonusGmxTracker tokens are deposited into the FeeGmxTracker which routes FTM to staked tokens

When minting MLP:

- The RewardRouter sends the funds to be deposited to the GlpManager and mints MLP ****tokens
- The RewardRouter then deposits the MLP tokens to the FeeGlpTracker which routes FTM to the staked tokens
- Finally the RewardRouter deposits the FeeGlpTracker tokens into the StakedGlpTracker which routes esMPX to staked tokens
...
To get claimable accrued fees you can use RewardReader.getStakingInfo(account rewardTrackers), this returns an array of uint256 values in the order:
