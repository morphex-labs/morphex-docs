...
- Collateralize wBLT in markets like Morpho to continue to receive automated fee-processing accrued fees while borrowing against wBLT (Borrowing wBLT itself is disabled)
