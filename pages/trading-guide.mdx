...
If this is your first time using the chain you've selected (Fantom, BNB Chain, or Base), then you will need to **add the network settings to your wallet** of choice:
-  **Fantom**: https://docs.fantom.foundation/tutorials/set-up-metamask
-  **Binance Smart Chain**: https://academy.binance.com/en/articles/connecting-metamask-to-binance-smart-chain
...
Also, for example, if you already have an open long position on FTM, opening a second long position on FTM will increase your current position. Separate additional positions would only be created if shorting FTM, or opening positions on other tokens.
