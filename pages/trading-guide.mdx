# Trading Guide for BMX Classic and Morphex
...
If this is your first time using the chain you've selected (Base, Fantom, or Mode), then you will need to **add the network settings to your wallet** of choice:
...
**BMX Classic and Morphex** supports both regular **swaps** and **leveraged trading**. In order to swap, click on the
...
For **long** positions, **profits** _are paid_ in the asset you are longing, e.g. if you long **ETH** you would **receive your profits in ETH**. For short positions, profits _will be paid_ in the same **stablecoin** used when opening the position.

## Order Types

### Market Orders

A **market order** is a type of trade that is executed at the current oracle price, without incurring any spread for assets like **ETH**. However, when trading long tail assets, such as MOG for **example**, there may be a small spread added. **Market orders** are the default option for all traders, and are ideal for those who wish to enter the market immediately.
...
During times of **high volatility**, there may be a spread between the **Pyth price** and the **Chainlink price**.
...
Below are links that share comprehensive details on how to use our charts and indicators:
-   [General Overview](https://twitter.com/MorphexBMX/status/1639945333819035649)
-   [Arnauld Legoux Moving Average (ALMA)](https://twitter.com/MorphexBMX/status/1642521360965726209)
-   [Bollinger Bands](https://twitter.com/MorphexBMX/status/1650118281758404608)
-   [Parabolic SAR](https://twitter.com/MorphexBMX/status/1644328412788703232)
