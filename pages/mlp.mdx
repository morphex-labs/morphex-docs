...
**Holders of MLP** _earn rewards_ in the form of _Escrowed **MPX**_ and a portion (**70%**) of _platform fees_ paid in **FTM**. It's important to note that the **fees** distributed to **MLP holders** are calculated after deducting referral rewards and network costs for keepers.
