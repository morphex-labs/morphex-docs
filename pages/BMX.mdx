...
When exercising Option 1 oBMX to BMX with the above discount, an exerciser would receive 12% discount from market-price of BMX based on a two-hour time-weighted average price (2-hour TWAP).

When exercising oBMX to wBLT-BMX for the minimum locked-LP duration of 10-days, an exerciser would receive 25% discount from market-price of BMX based on a two-hour time-weighted average price (2-hour TWAP).
## oBMX Option-Revenue
...
## Chainlink: Price Feeds, Contract Automation, and CCIP Integration
